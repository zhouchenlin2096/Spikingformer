...
## Requirements
timm==0.6.12; cupy==11.3.0; torch==1.14.0+cu116; spikingjelly==0.0.0.0.12; pyyaml; or 

timm==0.5.4; cupy==10.3.1; pytorch==1.10.0+cu111; spikingjelly==0.0.0.0.12; pyyaml;
